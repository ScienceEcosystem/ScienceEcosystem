    ...
    (function renderBranch(parentKey, depth){
      for(const c of (m.get(parentKey)||[])){
        ...
        const arrow=hasChildren
          ?`<button type="button" class="tree-arrow" title="${isCollapsed?'Expand':'Collapse'}" style="background:none;border:none;cursor:pointer;padding:0;margin:0;width:16px;height:16px;flex-shrink:0;display:flex;align-items:center;justify-content:center;color:#6b7280;">
