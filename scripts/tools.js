...
const toolCatalog = [
  ...
  },
  {
    ...
    summary: 'Browser-based AI assistant tuned for research search, summarization, and reading.',
    tags: ['assistant', 'summaries', 'search', 'papers', 'ai'],
    cost: 'Freemium',
    ease: 'Easy',
    open: false,
    collaboration: false,
    bestFor: 'Quickly searching and summarizing papers with an AI co-pilot.',
    alternatives: 'Elicit, Scite Assistant',
    link: 'https://positron.ai/',
    strengths: ['Search + chat', 'PDF grounding', 'Browser-based'],
    provider: 'Positron',
    baseScore: 2
  },
  {
