  ...
  Object.keys(byCategory).sort().forEach(function(cat) {
    ...
    byCategory[cat].slice().sort(function(a, b) {
      ...
      card.innerHTML =
        ...
        + (tool.link ? '<div style="margin-top:auto;padding-top:.25rem;"><a href="' + escT(tool.link) + '" target="_blank" rel="noopener noreferrer" style="font-size:.8rem;color:#006294;text-decoration:none;font-weight:600;">Visit ' + escT(tool.name) + ' →</a></div>' : '');
