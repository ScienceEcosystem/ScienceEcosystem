  ...
  card.innerHTML =
    ...
    + '<div style="margin-top:auto;padding-top:.25rem;display:flex;gap:.75rem;align-items:center;">'
      + '<a href="journal.html?name=' + encodeURIComponent(j.name) + '" '
        + 'style="font-size:.8rem;color:#006294;text-decoration:none;font-weight:600;">Full details →</a>'
      + '<a href="' + escJ(j.link) + '" target="_blank" rel="noopener noreferrer" '
...
function makeOpenAlexCard(s) {
  ...
  card.innerHTML =
    ...
    + '</div>'
    + '<div style="margin-top:auto;padding-top:.25rem;display:flex;gap:.75rem;align-items:center;">'
      + (pageUrl ? '<a href="' + escJ(pageUrl) + '" style="font-size:.8rem;color:#006294;text-decoration:none;font-weight:600;">Full details →</a>' : '')
